...
- The bot (backed by Claude) analyzes it and replies with a clear verdict:
...
Deploy as a normal Next.js project on [Vercel](https://vercel.com/new). Set the `ANTHROPIC_API_KEY` environment variable in the project settings.

## Stack

- Next.js (App Router)
- Anthropic Claude (vision + text) for fraud classification
